...
fn parse_block(
    ...
    match block_name {
        BLOCK_NAME_C8010_OUT => parse_c8010_response(block_data, block_len),
        ...
        BLOCK_NAME_S8202_OUT => parse_s8202_response(block_data, block_len),
        BLOCK_NAME_S8202_OUT1_ARRAY => parse_s8202_response1_array(block_data, block_len),
